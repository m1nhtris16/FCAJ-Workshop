...
* Thực hành bài Workshop "SLA & Monitoring", nghiên cứu mô hình 5 tầng Kim tự tháp Giám sát (Monitoring Pyramid).
...
| --- | --- | --- | --- | --- |
| 2 | - **Nghiên cứu Workshop SLA & Monitoring:** Học khái niệm SLA, phân tích khoảng cách giữa *Healthy Infrastructure* (CPU/RAM xanh) và *Healthy User Experience* (người dùng đăng nhập/nộp bài thành công). | 20/07/2026 | 20/07/2026 | [AWS Observability & CloudWatch Guide](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.html) |
...
* **Hoàn Thành Bài Workshop SLA & Monitoring:** Nắm vững mô hình Tháp Giám Sát 5 tầng, chuyển đổi tư duy từ giám sát hạ tầng sang giám sát trải nghiệm người dùng thực tế.

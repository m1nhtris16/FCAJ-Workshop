...
* Execute Workshop "SLA & Monitoring", mastering the 5-tier Monitoring Pyramid model.
...
| --- | --- | --- | --- | --- |
| Mon | - **Workshop SLA & Monitoring Study:** Study SLA principles, analyzing the gap between *Healthy Infrastructure* (green CPU metrics) and *Healthy User Experience* (successful login and submission execution). | 20/07/2026 | 20/07/2026 | [AWS Observability & CloudWatch Guide](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.html) |
...
* **Completed Workshop SLA & Monitoring:** Mastered the 5-tier Monitoring Pyramid model, shifting focus from raw infrastructure metrics to real customer journey monitoring.

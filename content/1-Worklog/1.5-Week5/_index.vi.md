...
* Thực hành bài Workshop 3.1 "Đảm bảo truy cập Hybrid an toàn đến S3 bằng cách sử dụng VPC endpoint" và cấu hình VPC Endpoint Policies.
